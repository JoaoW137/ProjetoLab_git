...
from graficos import janela_grafico, move_options
...
toggle_button = tk.Menu(menu, tearoff=False)
toggle_button.add_command(label='Side Options', command=lambda: move_options(root))
